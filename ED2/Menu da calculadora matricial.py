...
def escolher(x):
    if x > 0 and x < 4:
        a = int(input("Digite 1 para escolher matriz 1 da memoria ou \nDigite 2 para digitar matriz 1. "))
        while a!=1 and a!=2:# aqui é pra garantir que digite uma opção valida
            print("Essa opção não é valida, tenta de novo ai")
            a = int(input("Digite 1 para escolher matriz 1 da memoria ou \nDigite 2 para digitar matriz 1. "))
        if a == 1:
        ...
        a = int(input("Digite 1 para escolher matriz 2 da memoria ou \nDigite 2 para digitar matriz 2. "))
        ...
        if x == 1 or x == 2:
            if len(mat1)!=len(mat2) or len(mat1[0])!=len(mat2[0]):
                ...
                a = int(input("Digite 1 para escolher outras matrizes ou \nDigite 2 para retornar ao menu inicial. "))
                while a!=1 and a!=2:# aqui é pra garantir que digite uma opção valida ( é o unico jeito que eu sei )
                    print("Essa opção não é valida, tenta de novo ai")
                    a = int(input("Digite 1 para escolher outras matrizes ou \nDigite 2 para retornar ao menu inicial. "))
                if a == 1:
        ...
        a = int(input("Digite 1 para escolher matriz da memoria ou \nDigite 2 para digitar matriz. "))
        while a!=1 and a!=2:# aqui é pra garantir que digite uma opção valida
            print("Essa opção não é valida, tenta de novo ai")
            a = int(input("Digite 1 para escolher matriz da memoria ou \nDigite 2 para digitar matriz. "))
        if a == 1:
        ...
        if x == 4 or x == 6:
            if len(mat1) < 2:
                ...
                a = int(input("Digite 1 para escolher outras matriz ou \nDigite 2 para retornar ao menu inicial. "))
                while a!=1 and a!=2:# aqui é pra garantir que digite uma opção valida ( é o unico jeito que eu sei )
                    print("Essa opção não é valida, tenta de novo ai")
                    a = int(input("Digite 1 para escolher outras matriz ou \nDigite 2 para retornar ao menu inicial. "))
                if a == 1:
        ...
        if len(mat1) != 2 and len(mat1[0]) != 2:
            print('Impossível realizar operação, pois suas matriz não é do tipo 2x2. ')
            a = int(input("Digite 1 para escolher outras matriz ou \nDigite 2 para retornar ao menu inicial. "))
            while a!=1 and a!=2:# aqui é pra garantir que digite uma opção valida ( é o unico jeito que eu sei )
                print("Essa opção não é valida, tenta de novo ai")
                a = int(input("Digite 1 para escolher outras matriz ou \nDigite 2 para retornar ao menu inicial. "))
        ...
        elif(float(mat[0][0]) * float(mat[1][1]) - float(mat[0][1]) * float(mat[1][0])) == 0 :
            print('Impossível realizar operação, pois suas matriz possui determinante \nigual a 0, logo ela não é invertivel. ')
            a = int(input("Digite 1 para escolher outras matriz ou \nDigite 2 para retornar ao menu inicial. "))
            while a!=1 and a!=2:# aqui é pra garantir que digite uma opção valida ( é o unico jeito que eu sei )
                print("Essa opção não é valida, tenta de novo ai")
                a = int(input("Digite 1 para escolher outras matriz ou \nDigite 2 para retornar ao menu inicial. "))
...
def matriz_criar():
    m=int(input("Sua matriz possui quantas linhas? "))
    n=int(input("Sua matriz possui quantas colunas? "))
    mat=[]
    for i in range(m):
        linha=[]
        for j in range(n):
            a = float(input("Qual o elemento da {0}° linha, {1}° coluna? ".format(i,j)))
            lista.append(a)
        mat.append(linha)
    ...
    resp = int(input("Digite 1 se a matriz estiver certa ou \nDigite 2 para digitar novamente. "))
...
def resultado(x):
    ...
    if sal == 1:
        ...
        return menu()
#--------------------------------------------------AQUI SÃO TODAS AS OPERAÇÕES PRONTAS --------------------------------
def soma_subt(x,y,z):
    m = int(len(x))
    n = int(len(x[0]))
    mat = []
...
def som_lin_col(x,y):
    ...
    l1 = int(input('Digite o numero da {} que em que o resultado permanecera. '.format(pa)))
    l2 = int(input('Digite o numero da {} que você somara a linha escolhida a cima. '.format(pa)))
    for i in range(n):
        linha=[]
        if i == (l1-1):
            for j in range (n):
...
def per_lin_col(x,y):
    ...
    l1 = int(input('Digite o numero de uma das {}s que você quer permutar. '.format(pa)))
    l2 = int(input('Digite o numero da outra {} que você quer permutar. '.format(pa)))
    for i in range(n):
        linha=[]
        if i == (l1-1):
            for j in range (n):
...
def multi_lin_col_esc(x,y):
    ...
    l1 = int(input('Digite o numero da {0} que você quer multiplicar por {1}. '.format(pa,k)))
    for i in range(n):
        linha=[]
        if i == (l1-1):
            for j in range (n):
